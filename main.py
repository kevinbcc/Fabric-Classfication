...
from src.module import SimpleCNN_MLP,MLP2
...
g_mapping = {
    f"./{preprocessin_data_path}/C100.npy": (1.0, 0.0),
    f"./{preprocessin_data_path}/C80P20.npy": (0.777, 0.223),
    f"./{preprocessin_data_path}/C65P35.npy": (0.639, 0.361),
    f"./{preprocessin_data_path}/C50P50.npy": (0.485, 0.515),
    f"./{preprocessin_data_path}/C35P65.npy": (0.335, 0.665),
    f"./{preprocessin_data_path}/C20P80.npy": (0.188, 0.812),
    f"./{preprocessin_data_path}/P100.npy": (0.0, 1.0),
}
...
# 訓練模型並獲取回傳的參數
model, best_loss, final_lr = train_model(model, train_X, train_Y, epochs=epochs, criterion=criterion, optimizer=optimizer, scheduler=scheduler)
